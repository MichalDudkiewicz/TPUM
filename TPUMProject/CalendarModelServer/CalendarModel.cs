    ...
    public class CalendarModel : ICalendarModel
    {
        ...
        private void onAvailabilitesChange(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.Action == NotifyCollectionChangedAction.Add)
            {
                ...
                {
                    _availabilites.Add(Convert((CalendarLogicServer.IAvailability)item));
                }
            }
        ...
        public static IAvailability Convert(CalendarLogicServer.IAvailability a)
        {
        ...
        public int ActiveEmployeeId
        {
            ...
            set {
                ...
                List<CalendarLogicServer.IAvailability> newAvailabilities = _employeeAvailabilityManager.getAvailabilities().ToList();
                List<IAvailability> newLogicAvailabilities = newAvailabilities.ConvertAll(new Converter<CalendarLogicServer.IAvailability, IAvailability>(Convert));
